...
Optional `poll_interval_secs` in `~/.daku/settings.json` `extra` (default **120**). One shared `CollectorLoop` polls every Environment; Availability, jobs, and syslog register onto it.
