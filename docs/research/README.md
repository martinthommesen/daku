...
Landed on `main` (formerly orphan `research/*` branches). Read these instead of checking out historical branch names.
...
| Semaphore / transaction Signal spike (conditional no; 4 Operator probes open) | [semaphore-spike.md](./semaphore-spike.md) |
...
Prototype UI (variant C reference): [`prototypes/environments-overview/`](../../prototypes/environments-overview/).
